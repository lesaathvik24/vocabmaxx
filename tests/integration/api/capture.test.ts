...
describe('POST /api/capture', () => {
    ...
    it('200 on success — returns saved word', async () => {
        ...
        mockedFetch.mockResolvedValue({
            ok: true,
            value: { term: 'ubiquitous', def: { definition: 'd', examples: ['e'], source: 'dictionary', phonetic: null, audioUrl: null, senses: [] } },
        })
    ...
    it('409 on duplicate_term', async () => {
        ...
        mockedFetch.mockResolvedValue({
            ok: true,
            value: { term: 'dup', def: { definition: 'd', examples: ['e'], source: 'dictionary', phonetic: null, audioUrl: null, senses: [] } },
        })
